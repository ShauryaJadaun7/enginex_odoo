        ...
        <aside className={`w-64 border-r flex flex-col justify-between sticky top-0 h-screen ${darkMode ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'}`}>
            <div>
                <div className="p-6 flex items-center justify-between border-b border-slate-100 dark:border-slate-800">
                    <Logo className="h-5 w-5" textClassName="text-lg font-black" />
                ...
                <nav className="p-4 space-y-1">
                    {[
                        ...
                        { id: "drivers", label: "Driver Directory", icon: <Users className="h-4 w-4" />, roles: ["Safety Officer", "Dispatcher", "Fleet Manager"] },
                        { id: "trips", label: "Trip Dispatcher", icon: <MapPin className="h-4 w-4" />, roles: ["Dispatcher", "Fleet Manager"] },
                        ...
                        { id: "analytics", label: "Reports & ROI", icon: <BarChart3 className="h-4 w-4" />, roles: ["Financial Analyst", "Fleet Manager"] },

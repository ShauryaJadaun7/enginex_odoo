            ...
            <div>
                ...
                <nav className="p-4 space-y-1">
                    {[
                        ...
                        { id: "vehicles", label: "Vehicle Registry", icon: <Truck className="h-4 w-4" /> },
                        { id: "drivers", label: "Driver Directory", icon: <Users className="h-4 w-4" /> },
                        { id: "trips", label: "Trip Dispatcher", icon: <MapPin className="h-4 w-4" /> },
                        { id: "maintenance", label: "Maintenance Logs", icon: <Wrench className="h-4 w-4" /> },
                        { id: "expenses", label: "Fuel & Expenses", icon: <DollarSign className="h-4 w-4" /> },
                        { id: "analytics", label: "Reports & ROI", icon: <BarChart3 className="h-4 w-4" /> },
                    ].map(item => (
